...
func (m *MockIUserRepo) GetAddress(arg0 string) (*[]requestmodel.Address, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIUserRepoMockRecorder) GetAddress(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAddress", reflect.TypeOf((*MockIUserRepo)(nil).GetAddress), arg0)
}
...
func (m *MockIUserRepo) UserSignUp(arg0 *requestmodel.UserDetails) (*responsemodel.SignupData, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIUserRepoMockRecorder) UserSignUp(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UserSignUp", reflect.TypeOf((*MockIUserRepo)(nil).UserSignUp), arg0)
}
